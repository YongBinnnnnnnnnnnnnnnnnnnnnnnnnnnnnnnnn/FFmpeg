...
export LD_LIBRARY_PATH=/opt/mips32-mti-elf/2019.09-03-2/lib ./configure --arch=mips --target-os=none --cross-prefix=mips-mti-elf- --disable-asm --disable-programs --disable-muxer=hls --disable-encoders
